...
<div class="all-page">
    ...
    <div style="max-width:700px">
        <h5 class="about1"><span class="about2">Unleash your WILD Creative spirit!</span></h5>
        <h3 style="margin-left:20px;">"But only in their dreams can men be truly free, 'twas alwas thus and always thus will be."</h3>
        <p>
      <span style="margin-left:20px;">Do you know where this quote comes from?</p>

        <img src="dps.jpg" class="responsive" style="width:100%; max-width:1000px;margin-top:32px;">
    </div>
    </div>
</div>
