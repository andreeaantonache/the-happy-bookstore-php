...
<div class="all-page">
    ...
    <div style="max-width:700px">
        <h5 class="about1"><span class="about2">Hard work or divine inspiration?</span></h5>
        <h3 style="margin-left:20px;">BOTH. Does this have anything to do with being messy or extremely organized?</h3>
        <p>
      <span style="margin-left:20px;">Text about MASTERPIECE & Messy Desk...</p>

        <img src="mess.jpeg" class="responsive" style="width:100%; max-width:1000px;margin-top:32px;">
    </div>
    </div>
</div>
